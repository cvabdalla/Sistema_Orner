...
// Fix: Added React import and all missing icon exports used across the application

export const StarIcon: React.FC<{ className?: string, title?: string }> = ({ className = "w-6 h-6", title }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    {title && <title>{title}</title>}
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l2.07 6.368a1 1 0 00.95.69h6.691c.969 0 1.371 1.24.588 1.81l-5.414 3.933a1 1 0 00-.364 1.118l2.07 6.368c.3.921-.755 1.688-1.54 1.118l-5.414-3.933a1 1 0 00-1.175 0l-5.414 3.933c-.784.57-1.838-.197-1.539-1.118l2.07-6.368a1 1 0 00-.364-1.118L2.244 11.795c-.783-.57-.38-1.81.588-1.81h6.691a1 1 0 00.951-.69l2.07-6.368z" />
  </svg>
);
...
export const TruckIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 011 1v2a1 1 0 01-1 1m0-4h3m5 0h1a1 1 0 011 1v2a1 1 0 01-1 1m-1-4a2 2 0 00-2 2V20M8 20a2 2 0 100-4 2 2 0 000 4zm10 0a2 2 0 100-4 2 2 0 000 4z" />
  </svg>
);
...
export const Edit2Icon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
